...
# Save the results
lx.io.save_annotated_documents([result], output_name="chemical_compound_extraction.jsonl", output_dir=".")
# Generate the interactive visualization
html_content = lx.visualize("chemical_compound_extraction.jsonl")
with open("chemical_compound_extraction.html", "w", encoding="utf-8") as f:
